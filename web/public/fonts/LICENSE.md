# Fonts shipped with BLURT

Both faces are licensed under the **SIL Open Font License, Version 1.1**, which
permits bundling and redistribution with an application. They are vendored here as
latin-subset `woff2` files and served from this origin — BLURT never calls a font CDN
at runtime.

| File | Family | Designer / Foundry | Licence |
|---|---|---|---|
| `fredoka-500-600.woff2` | Fredoka (variable, wght 500–600) | Milena Brandão, Hafontia | SIL OFL 1.1 |
| `inter-400-700.woff2` | Inter (variable, wght 400–700) | Rasmus Andersson | SIL OFL 1.1 |

Both are used unmodified apart from subsetting to the `latin` unicode range, which the
OFL explicitly allows. Neither Reserved Font Name is used to describe a modified
version, and neither font is sold on its own.

The OFL requires that the copyright notices and the full licence text travel *with*
the font files rather than being linked, so both are reproduced below.

## Copyright notices

```
Copyright (c) 2016 The Inter Project Authors (https://github.com/rsms/inter)
Copyright (c) 2021 The Fredoka Project Authors (https://github.com/hafontia/Fredoka)
```
...
PARTICULAR PURPOSE AND NONINFRINGEMENT OF COPYRIGHT, PATENT, TRADEMARK, OR OTHER RIGHT.
